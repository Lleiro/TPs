...
void testeGetPosit(ListeTrieeChainee<string>*& ptrListe) {
    ...
    cout << " Postion de \"Jerome\" : " << ptrListe->getPosit("Jerome") << " ; devrait retourner 4" << endl;
...
void testeGetInfoAtPositRec(ListeTrieeChainee<string>*& ptrListe) {
    ...
    cout << " Info en position 4 : " << ptrListe->getInfoAtPositRec(4) << " ; devrait retourner \"Jerome\"" << endl;
...
void testeSupprimePremOccInfoRec(ListeTrieeChainee<string>*& ptrListe) {
    ...
    ptrListe->afficheCroissantRec();
    cout << endl;
    ptrListe->supprimePremOccInfoRec("Jerome");
    cout << "Après suppression de \"Jerome\" (au milieu), la liste contient : ";
    ptrListe->afficheCroissantRec();
    cout << endl;
...
void testeValeursDupliquees(ListeTrieeChainee<string>*& ptrListe) {
    ...
    ptrListe->afficheCroissantRec();
    cout << endl << endl;
    cout << "Insertion de \"Francis\", \"Ana\", \"Francis\", \"Herve\", \"Francis\", \"Philippe\"" << endl << "  -> ";
    ...
    cout << " Postion de \"Herve\" : " << ptrListe->getPosit("Herve") << " ; devrait retourner 7" << endl;
    cout << " Postion de \"Jerome\" : " << ptrListe->getPosit("Jerome") << " ; devrait retourner 9" << endl;
    ...
    cout << endl;
    ptrListe->supprimePremOccInfoRec("Jerome");
    cout << endl << "Après suppression de la première et unique occurrence de \"Jerome\", la liste contient : " << endl << " -> ";
    ptrListe->afficheCroissantRec();
    cout << endl;
...
La liste contient initialement : Ana Francis Herve Jerome Philippe Sophie 

Recherches de valeurs présentes ->
 Postion de "Ana" : 1 ; devrait retourner 1
 Postion de "Jerome" : 4 ; devrait retourner 4
...
Dans l'ordre croissant avec une procédure récursive, la liste contient :
   -> Ana Francis Herve Jerome Philippe Sophie 
Dans l'ordre croissant avec une procédure récursive, la liste contient :
   -> 
Ana Francis Herve Jerome Philippe Sophie 
DEBUT testeAffiche()
...
Insertion de Adam en début de liste 
  -> la liste contient : Adam Ana Francis Herve Jerome Philippe Sophie 
Insertion de Jacques en milieu de liste 
  -> la liste contient : Adam Ana Francis Herve Jacques Jerome Philippe Sophie 
Insertion de Violette en fin de liste 
  -> la liste contient : Adam Ana Francis Herve Jacques Jerome Philippe Sophie Violette 
...
Recherches de valeurs présentes ->
 ...
 Info en position 4 : Jerome ; devrait retourner "Jerome"
...
Après suppression en position 1 (le premier), la liste contient : Francis Herve Jerome Philippe Sophie 
Après suppression en position 4 (au milieu),  la liste contient : Francis Herve Philippe Sophie 
Après suppression en position 4 (le dernier), la liste contient : Francis Herve Philippe 
Après suppression en position 4 (trop loin),  la liste contient : Francis Herve Philippe 
...
Après suppression de "Ana" (le premier), la liste contient : Francis Herve Jerome Philippe Sophie 
Après suppression de "Jerome" (au milieu), la liste contient : Francis Herve Philippe Sophie 
Après suppression de "Sophie" (le dernier), la liste contient : Francis Herve Philippe 
Après suppression de "Adam" (avant le premier), la liste contient : Francis Herve Philippe 
Après suppression de "Jacques" (entre deux valeurs au milieu), la liste contient : Francis Herve Philippe 
Après suppression de "Violette" (après le dernier), la liste contient : Francis Herve Philippe 
...
Insertion de "Francis", "Ana", "Francis", "Herve", "Francis", "Philippe"
  -> La liste contient maintenant : Ana Ana Francis Francis Francis Francis Herve Herve Jerome Philippe Philippe Sophie 

Recherches de valeurs présentes ->
 Postion de "Ana" : 1 ; devrait retourner 1
 Postion de "Francis" : 3 ; devrait retourner 3
 Postion de "Herve" : 7 ; devrait retourner 7
 Postion de "Jerome" : 9 ; devrait retourner 9
...
Après suppression de la première occurrence de "Ana", la liste contient : 
 -> Ana Francis Francis Francis Francis Herve Herve Jerome Philippe Philippe Sophie 

Après suppression de la première et unique occurrence de "Jerome", la liste contient : 
 -> Ana Francis Francis Francis Francis Herve Herve Philippe Philippe Sophie 

Après suppression de la première occurrence de "Francis", la liste contient : 
 -> Ana Francis Francis Francis Herve Herve Philippe Philippe Sophie 

Après suppression de la première occurrence de "Philippe", la liste contient : 
 -> Ana Francis Francis Francis Herve Herve Philippe Sophie 

Après suppression de la première occurrence de "Ana", la liste contient : 
 -> Francis Francis Francis Herve Herve Philippe Sophie 
